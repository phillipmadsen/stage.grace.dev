		...
		<div class="toolbar-line ">	
			...
			<div class="btn-group">				
			   ...
			   <ul class="dropdown-menu" role="menu">
				  <li><a href="{{ URL::to('{class}/export/excel?md='.$masterdetail["filtermd"]) }}" title="Export to Excel" > Export Excel </a></li>
				  <li><a href="{{ URL::to('{class}/export/pdf?md='.$masterdetail["filtermd"]) }}" title="Export to PDF" > Export PDF </a></li>
