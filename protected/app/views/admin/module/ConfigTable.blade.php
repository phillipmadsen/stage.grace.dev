			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<td>
					...
					<select  name="align[<?php echo $id;?>]" class="form-control">
				...
				<td >
				<a style="padding-bottom:5px;" class="  btn-primary btn-xs btn tips exp-formater" title="Format Column Field" href="javascript:void(0)" rel="format-<?php echo $id;?>" ><i class="fa fa-cog"></i> More Option </a>
