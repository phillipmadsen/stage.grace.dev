...
<div class="" style="padding:30px;">			
  ...
  <div class="form-group standart-form file-upl"  style="display:none;">
	...
	<div class="col-md-8">
		<input name="path_to_upload" type="text" id="path_to_upload" class="form-control" value="<?php echo $f['option']['path_to_upload'];?>" placeholder="File Location ( ex : /uploads/images/ )"/>
		<hr />
		<b>File Type ? : </b> <br />
		<label class="radio"> 
		...
		<div class="imgResize form-inline">
			...
			<hr />
			 <b>  Multiple Upload File ? : </b> <br />
			<label class="checkbox"> 
				<input type="checkbox" name="is_multiple" value="1" 
				<?php if(isset($f['option']['is_multiple'])  && $f['option']['is_multiple'] == 1) echo 'checked="checked"';?>
				 />  Allow 
			</label>
		</div>
