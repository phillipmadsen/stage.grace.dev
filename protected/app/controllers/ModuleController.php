...
class ModuleController extends BaseController {
    ...
    public function postSavesetting()
    {
        ...
        $setting = array(
            ...
            'form-method'   => (!is_null(Input::get('form-method'))  ? Input::get('form-method') : 'native' ) ,
            'view-method'        => (!is_null(Input::get('view-method'))  ? Input::get('view-method') : 'native' ) ,
            'inline'        => (!is_null(Input::get('inline'))  ? 'true' : 'false' ) ,
